...
const { getReplyFromOpenAI, parseReminderWithOpenAI } = require('../utils/openai'); // openai.js in utils
const { sendWhatsAppMessage } = require('../utils/whatsapp'); // whatsapp.js in utils
const { getDb } = require('../utils/database'); // <--- السطر ده لازم يكون موجود والمسار صح
const { addReminder } = require('../scheduler/reminderQueue'); // reminderQueue.js in scheduler (assuming scheduler is sibling to routes)
